...
public class Main
{
    public static void main(String[] args)
    {
        ...
        Monstruo m1 = new Monstruo("Lesser Lich", "No-Muerto", 150, 45, dropLich, true);
        Monstruo m2 = new Monstruo("Chaos Lord Slime", "Organico", 475000, 457, dropSlime, true);
        Monstruo m3 = new Monstruo("Zombie", "No-muerto", 25, 5, dropComun, false);
        Monstruo m4 = new Monstruo("Automata de combate", "Constructo artificial", 45, 17, dropComun, false);
        Monstruo m5 = new Monstruo("Valstrax", "Drágon anciano", 75000, 40, dropElder, true);
